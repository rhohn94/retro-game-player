...
`workflow-scaffold` skill. The operational head (tier contract + Noir gate +
...
is `docs/design/release-planning-workflow-design.md`; the write-capable tier
design is `docs/design/write-capable-workflow-design.md`.
