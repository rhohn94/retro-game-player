...
> **Status:** stub — run `grm-design-language-adapt` to produce the full adaptation.
...
for your fork), then run the `grm-design-language-adapt` skill to clone the source
...
- Run `grm-design-language-adapt` to complete the initial adaptation.
