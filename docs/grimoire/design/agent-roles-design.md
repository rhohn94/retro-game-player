...
> and task-agent sections of `CLAUDE.md`, `docs/grimoire/integration-workflow.md`)
...
duplicated taxonomy table in `docs/grimoire/integration-workflow.md`. Other
...
- [ ] `docs/grimoire/integration-workflow.md` references this doc as the canonical role
