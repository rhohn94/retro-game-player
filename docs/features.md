...
| [docs/integration-workflow.md](integration-workflow.md) | Integration master's end-to-end release orchestration |
| [docs/version-design.md](version-design.md) | Branch model and versioning scheme in detail |
