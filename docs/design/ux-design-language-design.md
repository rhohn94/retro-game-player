...
- A second-level component library / theme system on top of the design
  language. The adapted local [design-language.md](ux/design-language.md) is the project's authority.
...
language is the source; the local [design-language.md](ux/design-language.md) is the **project's
...
A re-run **never overwrites the local [design-language.md](ux/design-language.md)** without an
...
1. **An embedded acceptance checklist** in the per-project
   [design-language.md](ux/design-language.md). Each item is of the form "the demo correctly shows
...
2. **Re-adaptation after upstream changes** (subsequent runs).
   ...
   - **Different SHA** → skill produces a **per-file diff** of upstream
     ...
     application**. The local [design-language.md](ux/design-language.md) is **not** rewritten;
...
- **Component library or theme system on top of [design-language.md](ux/design-language.md).** The
