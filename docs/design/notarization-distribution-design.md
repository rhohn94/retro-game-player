...
5. **Gatekeeper verification.** Always attempted against whatever DMG was
   ...
   (§6) — reports pass/fail either way; a failure here is expected and
...
- [x] The gap table in §7 is explicit about what shipped as tested plumbing
