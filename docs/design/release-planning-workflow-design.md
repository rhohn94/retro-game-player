...
the same structured result at the ~3× lower Haiku rate (`docs/token-efficiency-audit.md`
...
into `copilot/`. The gap is documented in `copilot/docs/integration-workflow.md`
